...
% Author(s)
\author{D.~Lebrun-Grandi{\'e}, A.~Prokopenko, S.~Slattery, B.~Turcksin}
...
MPI_Comm comm;
using Geometry = DTK::Point;
Kokkos::View<Geometry*, DeviceType> points;
// ... setup points ...
DTK::DistributedSearchTree bvh( comm, points );
using Query = DTK::Intersects<DTK::Sphere>;
