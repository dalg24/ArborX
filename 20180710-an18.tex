...
% Author(s)
\author{D.~Lebrun-Grandi{\'e}, D.~Arndt, A.~Prokopenko, B.~Turcksin}
...
\begin{block}{\centering Motivation}
  ...
  Search for geometric objects close in space is an important algorithm of many
...
\begin{block}{\centering Tree Construction}
  ...
  \begin{enumerate}
    \item User-provided geometric objects are wrapped in axis-aligned bounding boxes and the bounding box of the scene is computed (reduction)
    \item
...
\begin{block}{\centering More information}
  \textbf{https://github.com/arborx/ArborX} \\
  Tero Karras, \textit{Maximizing Parallelism in the Construction of BVHs, Octrees, and k-d Trees}.  High Performance Graphics, 2012.
\end{block}
...
This research used resources of the Compute and Data Environment for Science (CADES) at the Oak Ridge National Laboratory.
